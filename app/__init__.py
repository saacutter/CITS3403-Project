...
def create_application(config):
    ...
    os.makedirs(application.config['LOG_PATH'], exist_ok=True) # This is used to create the directory for log files (adapted from https://blog.miguelgrinberg.com/post/the-flask-mega-tutorial-part-vii-error-handling)
